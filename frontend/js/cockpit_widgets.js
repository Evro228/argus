...
(function () {
  ...
  const CONTINENTS_NORMALIZED = [
    // North America
    [[0.12, 0.15], [0.22, 0.13], [0.29, 0.18], [0.27, 0.28], [0.23, 0.38], [0.18, 0.45], [0.12, 0.40], [0.08, 0.28]],
    // South America
    [[0.22, 0.50], [0.30, 0.52], [0.32, 0.65], [0.26, 0.85], [0.22, 0.85], [0.20, 0.65]],
    // Europe
    [[0.44, 0.15], [0.55, 0.14], [0.53, 0.32], [0.46, 0.35], [0.42, 0.25]],
    // Africa
    [[0.45, 0.38], [0.58, 0.38], [0.60, 0.52], [0.53, 0.72], [0.48, 0.65], [0.43, 0.48]],
    // Asia
    [[0.56, 0.14], [0.86, 0.16], [0.88, 0.35], [0.76, 0.50], [0.68, 0.48], [0.56, 0.35]],
    // Australia
    [[0.78, 0.65], [0.88, 0.65], [0.89, 0.80], [0.80, 0.82]]
  ];
