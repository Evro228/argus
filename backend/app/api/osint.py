...
OSINT_TARGET_SITES = [
    ...
    {"name": "Docker Hub", "category": "Dev", "url": "https://hub.docker.com/u/{}", "check_url": "https://hub.docker.com/v2/users/{}/", "not_found_code": 404},
    {"name": "HackerNews", "category": "Forum", "url": "https://news.ycombinator.com/user?id={}", "check_url": "https://hacker-news.firebaseio.com/v0/user/{}.json", "not_found_code": 404},
    {"name": "Medium", "category": "Blogging", "url": "https://medium.com/@{}", "check_url": "https://medium.com/@{}", "not_found_code": 404},
    {"name": "Steam", "category": "Gaming", "url": "https://steamcommunity.com/id/{}", "check_url": "https://steamcommunity.com/id/{}", "not_found_code": 404},
    {"name": "Pinterest", "category": "Social", "url": "https://www.pinterest.com/{}/", "check_url": "https://www.pinterest.com/{}/", "not_found_code": 404},
    {"name": "Mastodon", "category": "Social", "url": "https://mastodon.social/@{}", "check_url": "https://mastodon.social/@{}", "not_found_code": 404},
    {"name": "Pastebin", "category": "Sharing", "url": "https://pastebin.com/u/{}", "check_url": "https://pastebin.com/u/{}", "not_found_code": 404},
    {"name": "Gravatar", "category": "Avatar", "url": "https://gravatar.com/{}", "check_url": "https://gravatar.com/{}", "not_found_code": 404},
    {"name": "Chess.com", "category": "Gaming", "url": "https://www.chess.com/member/{}", "check_url": "https://api.chess.com/pub/player/{}", "not_found_code": 404},
    {"name": "Disqus", "category": "Forum", "url": "https://disqus.com/by/{}/", "check_url": "https://disqus.com/by/{}/", "not_found_code": 404},
    {"name": "Vimeo", "category": "Media", "url": "https://vimeo.com/{}", "check_url": "https://vimeo.com/{}", "not_found_code": 404}
]
...
@router.get("/dorks")
def get_dorks(domain: Optional[str] = None):
    output = []
